...
"##,
    ...
    // === Generate OUT_DIR/.generated_templates.rs ===
    let gen_path = Path::new(&out_dir).join(".generated_templates.rs");
    let mut gen = File::create(&gen_path).expect("Failed to create .generated_templates.rs");

    write!(gen, "{}", r#"
// Auto-generated by build.rs — do not edit.

/// Constant array of template files as (path, contents) tuples.
pub const TEMPLATES: [(&str, &str); 13] = [
    ...
    ("src/web_resources.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/web_resources.rs"))),
    ("src/cargo.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/cargo.rs"))),
    ("src/lib.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/lib.rs"))),
    ("src/ollama_api_client.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/ollama_api_client.rs"))),
    ("src/openai_api_client.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/openai_api_client.rs"))),
    ("src/config/loader.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/config/loader.rs"))),
    ("src/config/mod.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/config/mod.rs"))),
    ("src/config/schema.rs", include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/templates/src/config/schema.rs"))),
];
